...
$lang['UAM_Tips1_txt'] = '
          <ul>
            ...
            <span style="font-style:italic">Recall: In standard operation, the "Guest" only sees the public categories, without information message.</span>
            </li><br><br>
            <li>
Prerequisite:<br>
...
B. In plugin PWG Stuffs :
              <ol>
                ...
                <li>Complete content of the module with the message information to be displayed to users not validated. As NBC_UAM, languages markup may be used if the plugin is enabled Extended Description</li>

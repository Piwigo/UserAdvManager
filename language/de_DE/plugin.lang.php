...
$lang['UserAdvManager_No_Comment_Anonymous_true'] = ' Der Autor Feld müssen ausgefüllt werden, um einen Kommentar zu schicken.';
...
/* Errors and Warnings */
/* TODO */$lang['mail_exclusionlist_error'] = 'Warning! You have entered a new line (CR-LF) at the begining of email exclusion list (shown in red below). Although this new line is not visible, it is still present and may cause malfunction of the plugin. Please re-type in your exclusion list in a manner that does not begin with a newline.';
...
/* ConfirmMail Configuration Tab */
$lang['ConfirmMail_Title'] = 'Erweiterte Einstellungen für die Validierung der Register';
$lang['Tab_ConfirmMail'] = 'Register Validierung Einstellungen';
/* UserList Tab */
$lang['Title_Tab5'] = 'UserAdvManager - Nutzungshinweise';
$lang['UserList_Title'] = 'Monitoring registrierte Benutzer';
$lang['Tab_UserList'] = 'Monitoring Benutzer';
$lang['UserAdvManager_User_List'] = 'Diese Seite gibt es zur Information an den Administrator. Es zeigt eine Liste von allen Nutzern auf der Galerie zeigt das Datum und die Anzahl der Tage seit dem letzten Besuch registriert. Die Liste ist in aufsteigender Reihenfolge der Anzahl der Tage sortiert.
<br><br>
Wenn der Geist Tracker aktiv ist, wird die Anzahl der Tage ohne einen Besuch wie der folgende Farbcode nach dem Maximum in der Ghost Tracker Optionen:
<br>
- <b style="color: lime;">Grün</b> : Wenn der Benutzer hat die Galerie <b style="color: lime;"><u>weniger als 50%</u></b> besucht der angegebene Höchstzahl in der Geist Tracker.<br>
- <b style="color: orange;">Orange</b> : Wenn der Benutzer hat die Galerie <b style="color: orange;"><u>zwischen 50% und 99%</u></b> besucht der angegebene Höchstzahl in der Geist Tracker.<br>
- <b style="color: red;">Red</b> : Wenn der Benutzer hat die Galerie <b style="color: red;"><u>für mehr als 100% </u></b> besucht der angegebene Höchstzahl in der Geist Tracker. <b><u>In diesem Fall muss der Benutzer sich auch in der Geist Tracker-Tabelle.</u></b><br>
<br>
Beispiel:
<br>
...
$lang['Title_Tab3'] = 'UserAdvManager - Management der Registrierung Validierungen';
$lang['Tab_UserManager'] = 'Validierungen Management';
/* Ghost Tracker Tab */
$lang['Reminder'] = 'Email Erinnerung';
/* Errors and Warnings */
$lang['Err_Userlist_Settings'] = 'Diese Seite ist nur verfügbar, wenn "Benutzer Monitoring" ist im "General Setup" aktiv ist.';
// --------- End: New or revised $lang ---- from version 2.13.0
// --------- Starting below: New or revised $lang ---- from version 2.13.1
/* Global Configuration Tab */
$lang['Title_Tab1'] = 'UserAdvManager 2.13.1 - Allgemeine Einstellungen';
/* ConfirmMail Configuration Tab */
$lang['Title_Tab2'] = 'UserAdvManager 2.13.1 - Registrieren Validierung Einstellungen';
// --------- End: New or revised $lang ---- from version 2.13.1
// --------- Starting below: New or revised $lang ---- from version 2.13.3
/* Global Configuration Tab */
$lang['UserAdvManager_Username_Char_true'] = ' Die folgenden Zeichen <b style="color: green;">(getrennte Werte durch Kommas ","!)</b> werden für den Benutzernamen Wahl verboten werden == ';
$lang['UserAdvManager_No_Comment_Anonymous'] = 'Aliases sind für Kommentare obligatorisch. <b style="color: red;">Aktivieren Sie diese Einstellung, wenn die Behörde nicht eingetragene Besucher gegeben um Kommentare zu schreiben (Admin-Panel Piwigo> Einstellungen> Allgemein, Registerkarte "Kommentare"> "Kommentare für alle erlaubt")</b>';

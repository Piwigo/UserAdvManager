...
$lang['UAM_Tips1_txt'] = '
          <ul>
            ...
            <span style="font-style:italic">Warnung: Im Standard-Betrieb, der "Gast" sieht nur den öffentlichen Kategorien, ohne Angaben Nachricht.</span>
            </li><br><br>
            <li>
Voraussetzung:<br>
...
B. In plugin PWG Stuffs :
              <ol>
                ...
                <li>Kompletten Inhalt des Moduls mit der Meldung Informationen, die den Benutzern angezeigt werden nicht validiert. Als NBC_UAM kann Markup-Sprachen verwendet werden, wenn das Plugin Extended Description aktiviert ist</li>

...
$lang['UAM_Reject_Page_Title'] = 'Η σύνδεση δεν επιτρέπεται!';
...
$lang['UAM_title_redir_page'] = 'Δεν επιτρέπεται η πρόσβαση έχοντας ένα λογαριασμό που καταργήθηκε!';
$lang['UAM_title_confirm_mail'] = 'Επιβεβαιώστε την εγγραφή σας';
...
$lang['UAM_reg_err_login4_%s'] = 'Ασφάλεια: Ένα σύστημα ελέγχου υπολογίζει τη βαθμολογία για την πολυπλοκότητα των επιλεγμένων κωδικών πρόσβασης. Η πολυπλοκότητα του κωδικού πρόσβασής σας είναι πολύ χαμηλή (βαθμολογία = %s). Παρακαλώ, επιλέξτε έναν νέο κωδικό πρόσβασης πιο ασφαλή, ακολουθώντας αυτούς τους κανόνες:<br>
...
$lang['UAM_confirm_mail_page_title'] = 'Επιβεβαιώστε την εγγραφή σας';
...
$lang['UAM Subjet manual validation for %s'] = 'Η καταχώρηση των %s αναμένει επικύρωση';
$lang['UAM Manual validation needed for %s'] = 'Ο χρήστης % καταχωρήθηκε και περιμένει χειροκίνητη επικύρωση από τον διαχειριστή';
?>
...
// | USA.                                                                  |
// +-----------------------------------------------------------------------+
$lang['UAM_AdminValidationMail_Subject_d'] = '
Όταν o Διαχειριστής ή ο Υπεύθυνος της γκαλερί επιβεβαιώνουν αυτόματη μια αναμονή εγγραφής, στέλνετε αυτόματα ένα email κοινοποίησης στον χρήστη. Εισάγετε εδώ χειροκίνητα το προσαρμοσμένο θέμα για το e-mail επικύρωσης.<br>

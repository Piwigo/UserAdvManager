...
- Gestión de visitantes fantasma<br>
...
$lang['UAM_casenTitle_d'] = 'De forma predeterminada, Piwigo es insensible a may&uacute;sculas y min&uacute;sculas se consideran letras diferentes en los nombres elegidos por los usuarios en el registro. Por lo tanto, &quot;foo&quot;, &quot;foo&quot; y &quot;foo&quot; puede ser de 3 diferentes usuarios.<br><br>
...
$lang['UAM_carexcTitle_d'] = 'Puede ser interesante para prohibir ciertos caracteres en nombres de usuario (por ejemplo, se niegan los inicios de sesi&oacute;n que contiene &quot;@&quot;). Esta opci&oacute;n permite excluir caracteres o secuencia de caracteres indeseados.<br>
Nota: Con esta opción también se puede excluir palabras completas.
<br><br>
<b style=&quot;color: red;&quot;>Advertencia: Esta opción no tiene efecto sobre los nombres de usuario creados antes de su activación.</b>';
...
No hay campo de prueba para medir la complejidad de una contraseña, y puede darse el lujo de tener una idea de la puntuación para definirla.<br><br>
Nota: La puntuación de una contraseña se calcula en función de varios parámetros: longitud, tipo de caracteres utilizados (letras, números, mayúsculas, minúsculas, caracteres especiales). Una puntuación por debajo de 100 se considera bajo, de 100 a 500, la complejidad es media, más allá de 500, la seguridad es excelente.';
$lang['UAM_passwtestTitle'] = 'Prueba de la complejidad de la contraseña';
$lang['UAM_passwtestTitle_d'] = 'Introduzca la contrase&ntilde;a para probar y luego haga clic en &quot;c&aacute;lculo del puntaje&quot; para ver el resultado.';
...
Nota: Si un usuario quiere cambiar la contraseña de una cuenta recien creada y el fortalecimiento de las contraseñas de los usuarios está activo, la misma estará sujeta a la norma establecida.';
...
$lang['UAM_infomailTitle_d'] = 'Esta opción permite automatizar el envío de un correo electrónico de información a un usuario cuando se registra o cuando cambie su contraseña o dirección de correo electrónico en su perfil.<br><br>
...
$lang['UAM_confirmmailTitle_d'] = 'Esta opción permite exigir a un usuario validar su registro haciendo clic en un enlace recibido en un correo electrónico enviado en el momento de la inscripción.<br><br>
El correo electr&oacute;nico se compone de una parte personalizable para introducir una nota de bienvenida y una parte fija que contiene el enlace de activaci&oacute;n que se genera a partir de una clave aleatoria que posiblemente puede regenerar a trav&eacute;s de &quot;Seguimiento de las Validaciones&quot;<br><br>
...
$lang['UAM_remailTitle_d'] = 'Esta opci&oacute;n le permite enviar un recordatorio por correo electr&oacute;nico a los usuarios registrados, pero que no han validado su inscripci&oacute;n a tiempo. Por lo tanto, trabaja en conjunto con la &quot;confirmaci&oacute;n de registro&quot;<br><br>
...
Si se deja en blanco, el aviso de correo electrónico estará vacía. Por tanto, es muy recomendable poner un pequeño texto explicativo. (Nota: El texto pre-llenado con la instalación del plugin se proporciona como un ejemplo)<br><br>
Para utilizar varios idiomas, puede utilizar las etiquetas para el plugin Extended description si está activo.<br><br>
<b style=&quot;color: red;&quot;>La modificaci&oacute;n de texto s&oacute;lo est&aacute; disponible si &quot;Recordar a los usuarios no validados&quot; est&aacute; activado.</b>';
$lang['UAM_ghosttrackerTitle'] = 'Gestión de  visitantes fantasma';
$lang['UAM_ghosttrackerTitle_d'] = 'Tambi&eacute;n se llama &quot;Ghost Tracker&quot;, cuando se activa esta funci&oacute;n, usted puede manejar sus visitantes en funci&oacute;n de la frecuencia de sus visitas. Cuando el tiempo entre 2 visitas a cumplido, el visitante en cuesti&oacute;n aparece en el &quot;Ghost Tracker&quot; tabla donde usted ser&aacute; capaz de recordar a los visitantes a trav&eacute;s de correo electr&oacute;nico.<br><br>
<b style=&quot;color: red;&quot;>Si habilita esta función por primera vez o ha reactivado después de un largo período durante el cual los nuevo visitantes  se han registrado de nuevo, usted debera inicializar o restablecer el Rastreador de Ghost.</b>';
...
- <b style=&quot;color: orange;&quot;>Naranja</b> : Cuando el usuario ha visitado la galería de <b style=&quot;color: orange;&quot;><u>entre 50% y 99%</u></b> de la máxima indicada en el Ghost Tracker.<br>
- <b style=&quot;color: red;&quot;>Rojo</b> : Cuando el usuario ha visitado la galería de <b style=&quot;color: red;&quot;><u>por más de 100%</u></b> de la máxima indicada en el Ghost Tracker. <b><u>En este caso, el usuario también debe aparecer en el cuadro Ghost Tracker.</u></b><br>
<br>
Ejemplo :
<br>
El período máximo de Ghost Tracker está configurado para 100 días.
<br>
Un usuario aparecerá en verde si visitó la galería desde menos de 50 días, en naranja si su última visita tuvo lugar entre el 50 y 99 días y el rojo durante 100 días o más.
<br><br>
<b>NOTA</b> : La lista no muestra que no han validado su registro (si la opci&oacute;n de validar el registro est&aacute; activado). Estos usuarios estan administrados despu&eacute;s de una manera especial en &quot;Seguimiento de las Validaciones&quot; ficha.';
$lang['UAM_usermanTitle'] = 'Seguimiento de las Validaciones';
$lang['UAM_usermanTitle_d'] = 'Cuando el plazo de inscripción está habilitado, podrá encontrar más adelante la lista de usuarios cuya validación de registro esta en espera, <b style=&quot;text-decoration: underline;&quot;>si o no</b> que están en el tiempo para validar.<br><br>
...
<br>
- Generar recordatorio por correo electrónico <b>sin</b> generar una nueva clave. Advertencia: Enviar un recordatorio por correo electrónico dirigido a los visitantes. Esta función no restaura la fecha de registro de visitantes objetivo y el tiempo de espera sigue siendo válido.
...
$lang['UAM_gtTitle'] = 'Gestión de los visitantes fantasma';
...
- Eliminar manualmente las cuentas de <b>(eliminación manual)</b>
<br>
- Generar recordatorio por correo electrónico <b>con el cambio de la fecha última visita</b>. Esto permite dar un comodín a los visitantes específicos. Si el visitante ya ha recibido un recordatorio, nada impide a reenviar un nuevo correo que se restablecerá de nuevo, de hecho, a la fecha de la última visita.';
?>

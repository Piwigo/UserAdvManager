...
$lang['UserAdvManager_No_Casse'] = ' Nombre de usuario insensible a mayusculas';
$lang['UserAdvManager_No_Casse_false'] = ' Dejar los usuarios sensible a mayusculas. (por defecto)';
$lang['UserAdvManager_Username_Char'] = ' Carácter limitado previsto para nombre de usuario';
$lang['UserAdvManager_Username_Char_true'] = ' Los siguientes caracteres serán prohibidos para los nombres de usuarios';
$lang['UserAdvManager_Username_Char_false'] = ' Utilice el control de nombre de usuario por defecto. ';
...
$lang['UserAdvManager_Confirm_Mail_false'] = ' Systema de inscripción y de actualizacion estandar sin confirmación de la dirección de mail.(valor por defecto)';
$lang['UserAdvManager_ConfirmMail_Text'] = ' Texto utilizado para la introdución del correo electrónico enviado al usuario que le permita validar su dirección de correo electrónico<br><b style="color: red;">(¡¡¡ </b><b style="text-decoration: underline; color: red;">¡ADVERTENCIA!</b> <b style="color: red;">La modificación de texto está disponible SOLO si está habilitada la confirmación de la dirección de correo electrónico. Utilice las etiquetas de múltiples idiomas de plugin Descripción extendido si se ha activado este plugin !!!)</b>';
$lang['UserAdvManager_Confirm_Group_Notice'] = 'ADVERTENCIA : El uso de grupos de validación requiere que se haya creado al menos un grupo de usuarios y se define "por defecto" en la gestión de Piwigo de grupos de usuarios.';
...
$lang['UserAdvManager_Validated_Group'] = 'Grupo a utilisar para los usuarios que han validado su dirección de correo electrónico.';
$lang['UserAdvManager_Confirm_Status_Notice'] = 'ADVERTENCIA :La utilisación de los estatutos de validación nesecita que haya conservado el usuario "invitado" para el parametraje por defecto (modelo) para los nuevos registrados. Nota, puede definir cualquier usuario como modelo para los nuevos registrados.  Por favor, consulte la documentación de Piwigo para obtener más detalles.';
$lang['UserAdvManager_No_Confirm_Status'] = 'Estatuto a utilizar para los usuarios que no han validado su dirección de correo electrónico.';
$lang['UserAdvManager_Validated_Status'] = 'Estatuto a utilizar para los usuarios que han validado su dirección de correo electrónico. Dejar ------- para el uso de valores por defecto de Piwigo';
$lang['UserAdvManager_No_Comment_Anonymous'] = 'Alias son obligatorios para los comentarios';
$lang['UserAdvManager_No_Comment_Anonymous_true'] = ' El campo de autor tienen que ser rellenados para enviar un comentario.';
$lang['UserAdvManager_No_Comment_Anonymous_false'] = ' Utilice la configuración predeterminada de Piwigo sobre los comentarios de envío. (por defecto)';
$lang['UserAdvManager_MailExclusion'] = 'Exclusión de proveedores de correo electrónico:';
...
$lang['UserAdvManager_MailExclusion_List'] = ' Si la exclusión proveedor de correo electrónico está ajustado a ON, complete  a continuación los dominios de correo electrónico para excluir. Tienes que utilizar el siguiente formato: <br>@[Nombre de dominio].[extensión de dominio] - Ejemplo: @hotmail.com <br>Separa los distintos ámbitos, con una coma (,)<br>';
...
$lang['UserAdvManager_Password_Enforced'] = 'Reforzamiento de contraseñas - Al habilitar esta opción hace que la toma de la contraseña sea obligatoria para los visitantes de registro. Además, la contraseña introducida por el visitante se encontrará con una puntuación de complejidad (<b style="color:green;"> activar y guardar la configuración para obtener más información </b>).';
$lang['UserAdvManager_Password_Enforced_Info'] = '<b style="text-decoration: underline; color: green;">Explicaciones:</b> <b style="color: green;">Una puntuación contraseña se calcula sobre los parámetros básicos: longitud, tipo de caracteres utilizados (letras, números, mayúsculas, minúsculas, caracteres especiales). Si la contraseña del usuario no coresponde a la puntuación, la puntuación alcanzada se monstrara con la puntuación mínima a alcanzar y una indicación para aumentar el valor de esta puntuación. Para hacerse una idea, una puntuación por debajo de 100 se considera "baja complejidad". Entre 100 y 500, la complejidad es media. Más de 500, es ¡Fort Knox! ;-)<br>Usted puede hacer la comprobación de sus contraseñas utilizando el campo de abajo. Esto le permitirá tener una idea de la puntuación para definir un nivel de complejidad media.</b>';
$lang['UserAdvManager_PasswordTest'] = 'Comprobación de contraseñas : ';
$lang['UserAdvManager_ScoreTest'] = 'Puntuación : ';
$lang['PasswordTest'] = 'Cálculo de la puntuación';
$lang['UserAdvManager_Password_Enforced_true'] = ' Contraseña fuerte requerida - Introduzca el valor mínimo de la complejidad de las contraseñas == ';
$lang['UserAdvManager_Password_Enforced_false'] = ' No fortalecer las contraseñas. (por defecto)';
$lang['UserAdvManager_AdminPassword_Enforced'] = '¿Aplicar también el control de complejidad de contraseñas cuando un administrador crea un usuario? Nota: Si el usuario creado desea cambiar su contraseña y el fortalecimiento de las contraseñas de los usuarios es activo, va a estar sujeto a las normas establecidas.';
$lang['UserAdvManager_AdminPassword_Enforced_true'] = 'Habilitar contraseñas para el fortalecimiento de las contraseñas  administradores.';
...
$lang['UserAdvManager_GhostTracker_ReminderText'] = ' Texto utilizado en el recordatorio por correo electrónico enviado  a los visitantes para animarles a visitar otra vez la galería (Nota: El texto pre-llenados en la instalación del plugin se muestra como un ejemplo).<br><b style="color: red;">(¡¡¡ </b><b style="text-decoration: underline; color: red;">¡ADVERTENCIA!</b> <b style="color: red;">Modificación de texto sólo está disponible si está habilitada Ghost Tracker. Utilice las etiquetas de múltiples idiomas de plugin Descripción extendido si se ha activado este plugin!)</b>';
// --------- End: New or revised $lang ---- from version 2.12.0 and 2.12.1
// --------- Starting below: New or revised $lang ---- from version 2.12.2
$lang['UserAdvManager_GhostTracker_Notice'] = 'Cuando está activada la característica Ghost Tracker, puede administrar sus visitantes en función de la frecuencia de sus visitas. <b style="color: red;">IMPORTANTE: Si activa esta función por primera vez o ha reactivado después de un largo período de tiempo  durante el que se han registrados nuevos visitantes, visite la ficha Tracker Ghost y siga las instrucciones para la inicialización Tracker Ghost.</b>';
// --------- End: New or revised $lang ---- from version 2.12.2
// --------- Starting below: New or revised $lang ---- from version 2.12.6
$lang['UserAdvManager_No_Casse_true'] = ' Hacer que la cuenta usuario sea insensibles a mayusculas en el registro e identificación. (USER = user = User = usER...).';
...
$lang['UserAdvManager_ConfirmMail_Info'] = 'Limitación de tiempo para la validación de la inscripción: <br>Si habilita esta opción, seleccione el tiempo deseado (x) en el campo de abajo. Los visitantes que se registren tendrán entonces x días para validar su inscripción. Después de este período en el enlace de validación que han recibido por correo hara vencido.<br>';
$lang['UserAdvManager_ConfirmMail_TimeOut_true'] = 'Habilitar la limitación del plazo de inscripción.';
$lang['UserAdvManager_ConfirmMail_TimeOut_false'] = 'Deshabilitar limitar el plazo de inscripción. (por defecto)';
...
$lang['UserAdvManager_ConfirmMail_Remail'] = 'Recordatorio por correo electrónico para activar o desactivar registros validados:';
$lang['UserAdvManager_ConfirmMail_Remail_true'] = 'Activar recordatorio por correo electrónico';
$lang['UserAdvManager_ConfirmMail_Remail_false'] = 'Deshabilitar recordatorio por correo electrónico. (por defecto)';
$lang['UserAdvManager_ConfirmMail_ReMail_Txt1'] = 'Contenido personalizado del mensaje recordatorio con la regeneración de la clave de validación. <br>Si deja en blanco, el recordatorio por correo electrónico sólo se incluirá el enlace de validación. Por tanto, es muy recomendable poner un pequeño texto explicativo. (Nota: El texto pre-llenados en la instalación del plugin se muestra como un ejemplo)<br><br><b style="color: red;">(¡¡¡ </b><b style="text-decoration: underline; color: red;">¡ADVERTENCIA!</b> <b style="color: red;">Modificación de texto sólo está disponible si está habilitado el recordatorio por correo electrónico. Utilice las etiquetas de múltiples idiomas de plugin Descripción extendido si se ha activado este plugin !!!)</b>';
$lang['UserAdvManager_ConfirmMail_ReMail_Txt2'] = 'Contenido personalizado del mensaje recordatorio sin regeneración de la clave de validación.<br>Si se deja en blanco, el recordatorio por correo electrónico sólo se incluirá el enlace de validación. Por tanto, es muy recomendable poner un pequeño texto explicativo. (Nota: El texto pre-llenados en la instalación del plugin se muestra como un ejemplo)<br><br><b style="color: red;">(¡¡¡ </b><b style="text-decoration: underline; color: red;">¡ADVERTENCIA!</b> <b style="color: red;">Modificación de texto sólo está disponible si está habilitada recordatorio por correo electrónico. Utilice las etiquetas de múltiples idiomas de plugin Descripción extendido si se ha activado este plugin !!!)</b>';
...
$lang['UserAdvManager_ConfirmMail_User_List'] = 'Cuando el limite de plazo de inscripción está habilitado, podrás encontrar más abajo la lista de usuarios en espera de validación, ya sea que <b style="text-decoration: underline;">estén o no</b> dentro del  tiempo para validar.<br><br>En esta vista, puede:
<br><br>
- Eliminar manualmente las cuentas de <b>(eliminación manual)</b>
<br>
- Generar recordatorio por correo electrónico <b>sin</b> generar una nueva clave. Advertencia: Enviar un recordatorio por correo electrónico dirigido a los visitantes. Esta función no actualiza la fecha de registro del visitantes objetivo el tiempo de espera sigue siendo válido.
<br>
- Generar recordatorio por correo electrónico <b>con</b> generar una nueva clave. Advertencia: Enviar un recordatorio por correo electrónico dirigido a los visitantes. Esta función actualiza la fecha de registro de visitantes y específicos, que equivale a prorrogar el plazo para la validación.
<br>
- Presentar una solicitud de registro en espera de validación manual, aunque la fecha de caducidad haya pasado <b>(forzando la validación)</b>.
<br>';
...
$lang['confirm_mail_ok'] = '<br><br><br>Gracias por haber confirmado su dirección de correo electrónico y su registro en la galería. ¡Have fun!<br><br><br><br>';
$lang['confirm_mail_bad'] = '<br><br><br>Su clave de activación es incorrecta o está vencida o que ya ha validado su cuenta, por favor, póngase en contacto con el webmaster para solucionar este problema.<br><br><br><br>';


/* Errors and Warnings */
$lang['UserAdvManager_audit_ok'] = 'Auditoría OK';
$lang['Err_audit_no_casse'] = '<b>Estas cuentas estan sensibles a mayusculas:</b> ';
...
$lang['Err_audit_advise'] = '<b>Usted tiene que realizar correcciones para cumplir con las normas que ha activado.<br>Use una herramienta de gestión de base de datos para corregir las cuentas de usuario directamente en la tabla ###_USERS';
...
$lang['Err_ConfirmMail_Settings'] = 'Esta página estará disponible sólo si la "Confirmación de correo electrónico" está activada en "Configuración general".';
...
$lang['reg_err_login3'] = '¡Seguridad: La contraseña es obligatoria!';
$lang['reg_err_login4_%s'] = 'Seguridad: Un sistema de control calcula la puntuación de la complejidad de las contraseñas elegidas. La complejidad de la contraseña es demasiado baja (puntuación = %s). Por favor, elija una nueva contraseña más segura siguiendo estas reglas:<br>
- Usar letras y números<br>
- Utilice minúsculas y mayúsculas<br>
- Aumentar su longitud (número de caracteres)<br>
La Puntuación mínima exigida por el administrador es el siguiente: ';
$lang['No_reminder_for_Guest'] = 'La cuenta"Invitado" no está sujeta a recibir recordatorios de Ghost Tracker';
$lang['No_reminder_for_default_user'] = 'La cuenta predeterminada no está sujeta a recibir recordatorios de Ghost Tracker';
...
/* TODO */$lang['mail_text_error'] = '<b>Warning!</b> - Semicolons (;) are not allowed in addtionnal email text. This Character have been automatically replaced by a dot (.). For information, the amended text(s) is(are) shown in red in the corresponding field(s). Please, check it(them) out.';
// --------- End: New or revised $lang ---- from version 2.12.7


/* Processing messages */
$lang['%d_Mail_With_Key'] = '%d mensaje con la clave de la renovación ha sido enviado';
$lang['%d_Mails_With_Key'] = '%d Mensajes con la renovación de claves han sido enviados';
$lang['%d_Reminder_Sent'] = '%d mensaje recordatorio ha sido enviado';
$lang['%d_Reminders_Sent'] = '%d mensajes recordatorios han sido enviados ';
...
$lang['Force_Validation'] = 'Validación obligatoria';

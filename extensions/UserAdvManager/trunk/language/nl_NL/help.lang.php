...
$lang['UAM_userlistTitle_d'] = 'Dit is een informatiepagina voor de beheerder. Het toont een lijst met alle geregistreerde gebruikers naar datum en het aantal dagen sinds hun laatste bezoek. De lijst is gesorteerd in het oplopende aantal dagen.
<br/><br/>
...
Voorbeeld:
<br/>
In Ghost Tracker is de maximale periode is ingesteld op 100 dagen.
<br/>
...
$lang['UAM_remailtxt2Title_d'] = 'Voeg je eigen introductietekst in de herinneringsemail zonder de opnieuw gegenereerde bevestigingssleutel.
<br/><br/>
Als je dit veld leeg laat zal de herinneringsemail geen inhoud bevatten. Het wordt sterk aanbevolen om een kleine tekstuitleg in te voegen. (NB. De vooraf ingevulde tekst is bedoeld als voorbeeld)
<br/><br/>
Vervolgens kan je de inhoud aanpassen met speciaal ingevoegde labels:<br/>
- <b style=&quot;color: red;&quot;>[gebruikersnaam]</b> het automatisch invoegen van de naam van de gebruiker voor wie de email bestemd is.<br/>
- <b style=&quot;color: red;&quot;>[mygallery]</b> het invoegen van de titel van je galerie.<br/>
...
<br/><br/>
Voor meerdere talen kan je de labels van de plugin Extended Description gebruiken als deze is geactiveerd.';
$lang['UAM_remailtxt1Title_d'] = 'Voeg je eigen introductietekst in de herinneringsemail met de opnieuw gegenereerde bevestigingssleutel.
<br/><br/>

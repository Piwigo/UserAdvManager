  ...
  <fieldset>
    ...
    <ul>
      ...
      <br/>
        ...
        <textarea name="UserAdvManager_MailExclusion_List" id="UserAdvManager_MailExclusion_List" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UserAdvManager_MAILEXCLUSION_LIST}</textarea>
    	</li>
    	</li>
    </ul>

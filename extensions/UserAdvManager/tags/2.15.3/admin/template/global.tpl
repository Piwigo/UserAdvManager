  ...
  <div id="instructionConfig1" class="instructionBlock" >
    ...
    <div id="Config1" class="instructionBlockContent" style="display:none">
      <fieldset>
        <ul>
          <li>
            <label class="cluetip" title="{'UAM_casenTitle'|translate}|{'UAM_casenTitle_d'|translate}">
              {'UAM_No_Casse'|@translate}
            </label>
          <br><br>
            <input type="radio" value="false" {$UAM_NO_CASSE_FALSE} name="UAM_No_Casse">
              {'UAM_No_Casse_false'|@translate}<br>
            <input type="radio" value="true" {$UAM_NO_CASSE_TRUE} name="UAM_No_Casse">
              {'UAM_No_Casse_true'|@translate}<br><br>
          </li>
          ...
          {if $UAM_MAILEXCLUSION_TRUE}
            {if $UAM_ERROR_REPORTS4}     
              <div id="uam_leftmargin">
                <textarea name="UAM_MailExclusion_List" id="UAM_MailExclusion_List" rows="3" cols="80" style="color: red" {$TAG_INPUT_ENABLED}>{$UAM_MAILEXCLUSION_LIST}</textarea>
              </div>
            <br><br>
            {else}
              <div id="uam_leftmargin">
                <textarea name="UAM_MailExclusion_List" id="UAM_MailExclusion_List" rows="3" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_MAILEXCLUSION_LIST}</textarea>
              </div>
            <br><br>
            {/if}
          {else}
            <div id="uam_leftmargin">
              <textarea name="UAM_MailExclusion_List" id="UAM_MailExclusion_List" rows="3" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_MAILEXCLUSION_LIST}</textarea>
            </div>
          <br><br>
          {/if}
        </ul>
        ...
        <ul>
          ...
          <ul>
            {if $UAM_MAIL_INFO_TRUE}
              ...
              <br><br>
                <textarea name="UAM_MailInfo_Text" id="UAM_MailInfo_Text" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_MAILINFO_TEXT}</textarea>
              <br><br>
              </li>
            {else}
              <li>
              ...
              <br><br>
                <textarea name="UAM_MailInfo_Text" id="UAM_MailInfo_Text" rows="10" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_MAILINFO_TEXT}</textarea>
              <br><br>
              </li>
            {/if}
<!--
         ...
         <br><br>
          ...
          <ul>
            ...
            {if $UAM_CONFIRM_MAIL_TRUE}
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Text" id="UAM_ConfirmMail_Text" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_TEXT}</textarea>
              <br><br>
              </li>
            {else}
              <li>
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Text" id="UAM_ConfirmMail_Text" rows="10" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_TEXT}</textarea>
              <br><br>
              </li>
            {/if}
<!--
...
-->
            {if $UAM_CONFIRM_MAIL_TRUE}
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Custom_Txt1" id="UAM_ConfirmMail_Custom_Txt1" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_CUSTOM_TXT1}</textarea>
              <br><br>
              </li>
              {if 'FCK_PATH'|@defined}
                <div style="text-align:right;">
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Custom_Txt2" id="UAM_ConfirmMail_Custom_Txt2" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_CUSTOM_TXT2}</textarea>
              <br><br>
              </li>
              {if 'FCK_PATH'|@defined}
                <div style="text-align:right;">
            ...
            {else}
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Custom_Txt1" id="UAM_ConfirmMail_Custom_Txt1" rows="10" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_CUSTOM_TXT1}</textarea>
              <br><br>
              </li>
              ...
              <br><br>
                <textarea name="UAM_ConfirmMail_Custom_Txt2" id="UAM_ConfirmMail_Custom_Txt2" rows="10" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_CUSTOM_TXT2}</textarea>
              <br><br>
              </li>
            {/if}
          </ul>
          ...
          <div id="uam_notice">{'UAM_Confirm_grpstat_notice'|@translate}</div>
            ...
            <ul>
              {if $UAM_CONFIRMMAIL_REMAIL_TRUE}
                ...
                <br><br>
                  <textarea name="UAM_ConfirmMail_ReMail_Txt1" id="UAM_ConfirmMail_ReMail_Txt1" rows="10" cols="80" {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_REMAIL_TXT1}</textarea>
                <br><br>
                </li>
              {else}
                <li>
                ...
                <br><br>
                  <textarea  name="UAM_ConfirmMail_ReMail_Txt1" id="UAM_ConfirmMail_ReMail_Txt1" rows="10" cols="80" readonly{$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_REMAIL_TXT1}</textarea>
                <br><br>
                </li>
              {/if}
<!--
...
-->
              ...
              {else}
                ...
                <br><br>
                  <textarea name="UAM_ConfirmMail_ReMail_Txt2" id="UAM_ConfirmMail_ReMail_Txt2" rows="10" cols="80" readonly {$TAG_INPUT_ENABLED}>{$UAM_CONFIRMMAIL_REMAIL_TXT2}</textarea>
                <br><br>
                </li>
              {/if}
<!--

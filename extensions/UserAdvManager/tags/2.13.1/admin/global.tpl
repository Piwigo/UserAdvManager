...
{if $UserAdvManager_MAILEXCLUSION_TRUE}
  {if $UserAdvManager_ERROR_REPORTS4}     
        ...
        <textarea name="UserAdvManager_MailExclusion_List" id="UserAdvManager_MailExclusion_List" rows="3" cols="80" style="color: red" {$TAG_INPUT_ENABLED}>{$UserAdvManager_MAILEXCLUSION_LIST}</textarea><br><br>
    	</li>
  {else}
    	<li><label>{'UserAdvManager_MailExclusion_List'|@translate}</label><br>
...
{if $UserAdvManager_GHOSTRACKER_TRUE}
    	<br>
			<div style="text-align: left; color: green;"><b>{'UserAdvManager_GhostTracker_Notice'|@translate}</b></div>
			<br>
{/if}
...
{/if}
    	...
    	<li><label>{'UserAdvManager_Add_LastVisit_Column'|@translate}</label><br>
        <input type="radio" value="true" {$UserAdvManager_ADDLASTVISIT_TRUE} name="UserAdvManager_Add_LastVisit_Column">{'UserAdvManager_Add_LastVisit_Column_true'|@translate}<br>
        <input type="radio" value="false" {$UserAdvManager_ADDLASTVISIT_FALSE} name="UserAdvManager_Add_LastVisit_Column">{'UserAdvManager_Add_LastVisit_Column_false'|@translate}<br><br>
    	</li>
    </ul>

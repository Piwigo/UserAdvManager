...
/* Pending because this may cause problems with special characters in emails */
/*$toolbar = 'Basic';
$width = '750px';
$height = '300px';
$areas = array();
...
/* Check if CR-LF exist at begining and end of mail exclusion list - If yes, removes them */
    ...
    $conf['nbc_UserAdvManager'] = serialize($newconf_UAM);

		$query = '
	  	UPDATE '.CONFIG_TABLE.'
	  	SET value="'.addslashes($conf['nbc_UserAdvManager']).'"
...
/* Email confirmation settings */
    ...
    $conf['nbc_UserAdvManager_ConfirmMail'] = serialize($newconf_UAM_ConfirmMail);
    
	  $query = '
      UPDATE '.CONFIG_TABLE.'
			SET value="'.addslashes($conf['nbc_UserAdvManager_ConfirmMail']).'"

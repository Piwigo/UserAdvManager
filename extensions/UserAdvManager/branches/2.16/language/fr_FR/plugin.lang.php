...
$lang['UAM_GTAuto_false'] = ' Désactiver (valeur par défaut)';
$lang['UAM_GTAuto_true'] = ' Activer';
...
$lang['UAM_GTAutoMail_false'] = ' Désactiver (valeur par défaut)';
$lang['UAM_GTAutoMail_true'] = ' Activer';
$lang['Deleted_Account_Redirection_Page'] = 'Accès refusé - Compte détruit !';
$lang['title_redir_page'] = 'Accès refusé pour cause de compte détruit !';
$lang['Error_GTAutoMail_cannot_be_set_without_ConfirmMail'] = 'Erreur de cohérence dans la configuration choisie :<br><br>
...
Pour garantir la cohérence, l\'option "Email automatique sur changement de groupe / statut" a été automatiquement repositionnée en "désactivé".<br><br>';
$lang['Demotion of %s'] = 'Rétrogradation de %s';
$lang['UAM_AdminValidationMail_Text'] = 'Notification de validation d\'inscription manuelle';
$lang['Validation of %s'] = 'Validation de %s';

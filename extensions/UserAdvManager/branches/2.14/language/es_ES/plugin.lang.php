...
$lang['confirm_mail_ok'] = '<br><br><br>Gracias por haber confirmado su dirección de correo electrónico y su registro en la galería. ¡Que se divierta!<br><br><br><br>';


/* Errors and Warnings */
$lang['UAM_audit_ok'] = 'Auditoría OK';
$lang['Err_audit_no_casse'] = '<b>Estas cuentas son idénticas sensibles a mayusculas:</b> ';
...
$lang['UAM_Empty Author'] = 'El campo de autor tienen que estar llenado para enviar un comentario.';
if ( isset($conf_UAM[1]) and $conf_UAM[1] == 'true' )
	$lang['reg_err_login5'] = 'Este nombre de usuario ya existe, ADVERTENCIA el nombre no es sensible a mayúsculas (Shift = pequeño).';
$lang['reg_err_login6'] = 'Nombre de usuario no debe coincidir con los siguientes caracteres: ';
...
$lang['Force_Validation'] = 'Validación obligada';
...
$lang['reg_err_login4_%s'] = 'Seguridad: Un sistema de control calcula la puntuación de la complejidad de las contraseñas elegida . La complejidad de la contraseña es demasiado baja (puntuación = %s). Por favor, elija una nueva contraseña más segura siguiendo estas reglas:<br>
- Usar letras y números<br>
- Utilice minúsculas y mayúsculas<br>
- Aumentar su longitud (número de caracteres)<br>
La puntuación mínima de las contraseñas  exigida por el administrador es el siguiente: ';
...
/* Errors and Warnings */
$lang['GhostTracker_Init_OK'] = '¡Initialización de Ghost Tracker hecha!';
/* Action button names */
...
$lang['UAM_Title1'] = 'Configuración de las restricciones para el registro';
...
$lang['UAM_ConfirmMail_ReMail_Txt1'] = 'Personalización del mensaje recordatorio <b><u>con</u></b> la regeneración de una nueva clave de validación .';
$lang['UAM_ConfirmMail_ReMail_Txt2'] = 'Personalización del mensaje recordatorio <b><u>sin</u></b> la regeneración de una nueva clave de validación.';

$lang['UAM_GhostTracker'] = 'Gestión de usuarios fantasmas (Tracker Ghost)';
...
$lang['UAM_Tips1'] = 'Validación de los registros de correo electrónico y mensaje de advertencia en la página principal de Piwigo';
...
$lang['GhostTracker_Title'] = 'Gestión de usuarios fantasmas';
...
$lang['UAM_Tips1_txt'] = '
          <ul>
            ...
            <span style="font-style:italic">Recuerde: En funcionamiento normal, el "Invitado" sólo ve las categorías de público, sin mensaje de información.</span>
            </li><br><br>
            <li>
Requisito previo:<br>
- Una galería con todas o algunas categorías privadas, visible sólo por los usuarios registrados<br>
- Al menos los 2 siguientes grupos Piwigo  de usuarios: "Espera," sin permiso en las categorías de privados, y "Validado" con todos los permisos en las categorías de privados<br>
- NBC_UAM plugin<br>
...
B. En plugin PWG Stuffs :
              <ol>
                ...
                <li>El contenido completo del módulo con la información del mensaje que se mostrará a los usuarios no validados. Como NBC_UAM, lenguajes de marcas pueden ser utilizados si el plugin Extended Description está activado</li>

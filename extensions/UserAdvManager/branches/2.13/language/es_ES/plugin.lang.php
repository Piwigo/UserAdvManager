...
$lang['Err_audit_username_char'] = '<b>En esta cuenta se utiliza uno o más caracteres prohibidos:</b> ';
$lang['Err_audit_email_forbidden'] = '<b>En esta cuenta se utiliza un proveedor de correo electrónico prohibido:</b> ';
...
$lang['UserAdvManager_Empty Author'] = 'El campo de autor tienen que ser rellenados para enviar un comentario.';
if ( isset($conf_UserAdvManager[1]) and $conf_UserAdvManager[1] == 'true' )
	$lang['reg_err_login5'] = 'El nombre de usuario ya existe, es sensible a mayúsculas (Shift = pequeño).';
...
$lang['No_validation_for_your_account'] = 'La cuenta  administrador personnal no está sujeta a la validación';
$lang['Database_Error'] = '<b><u>¡Advertencia! Error de integridad crítica en su base de datos.</u></b><br><br>Por favor, compruebe la integridad de la tabla de #_user_confirm_mail.';
...
$lang['reg_err_login4_%s'] = 'Seguridad: Un sistema de control calcula la puntuación de la complejidad de las contraseñas. La complejidad de la contraseña es demasiado baja (puntuación = %s). Por favor, elija una nueva contraseña más segura siguiendo estas reglas:<br>
...
$lang['No_reminder_for_your_account'] = 'La cuenta administrador personnal no está sujeto a recibir recordatorios de Ghost Tracker';
/* Action button names */
...
/* Errors and Warnings */
$lang['mail_text_error'] = '<b>¡Advertencia!</b> - Punto y coma (;) no están permitidos en el texto del mensaje addtionnal. Este carácter sera sustituido automáticamente por un punto (.). Para más información, el texto modificado(s) es(son) se muestra en rojo en el campo correspondiente(s). Por favor, compruebelos.';
...
$lang['UserAdvManager_Title1'] = 'Configuración de las restricciones para el registro';
$lang['UserAdvManager_Title2'] = 'Configuración de las confirmaciones y validaciones de registro';
$lang['UserAdvManager_Title3'] = 'Configuración de los registros seguidos y otras opciones';
...
$lang['UserAdvManager_Password_Enforced'] = 'Fuerza del nivel de seguridad de las contraseñas';
...
$lang['UserAdvManager_PasswordTest'] = 'Comprueba la contraseña: ';
...
$lang['UserAdvManager_GhostTracker'] = 'Gestión de visitantes fantasmas(Tracker Ghost)';
...
$lang['GhostTracker_Title'] = 'Gestión de los visitantes fantasma';

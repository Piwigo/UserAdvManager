...
VALUES ("nbc_UserAdvManager","false;false;false;-1;-1;-1;false;false;;-1;;;false;;false;100;false;false;10;Hello.
...
The admin of the gallery.;false","Parametres du plugin nbc UserAdvManager")
  ;';
  pwg_query($q);
...
/* Upgrade plugin configuration */
  ...
  if ((!isset($conf_nbc_UserAdvManager[20])))
  {
...
function update_files($plugin_id)
{
  $clean = clean_obsolete_files(UAM_OBSOLETE);
}
?>